      ...
      <section className="relative h-[100svh] overflow-hidden bg-white md:h-[calc(100vh-80px)]">
        <div className="relative mx-auto flex h-full max-w-[1920px]">
          ...
          <div className="relative h-full flex-1 overflow-hidden">
            ...
            {mobileSummary ? <button className={`absolute inset-x-0 bottom-[88px] z-30 bg-white text-left shadow-[0_-8px_28px_rgba(17,17,17,0.08)] md:hidden ${mobilePanelOpen ? "hidden" : "block rounded-t-[28px] px-7 py-7"}`} onClick={() => setMobilePanelOpen(true)} type="button">{mobileSummary}</button> : null}
