      ...
      <section className="relative h-[calc(100vh-80px)] overflow-hidden bg-white">
        <div className="relative mx-auto flex h-full max-w-[1920px]">
          ...
          <div className="relative h-full flex-1 overflow-hidden">
            ...
            {mapOverlay}
            {mobileSummary ? <div className="absolute inset-x-0 bottom-0 block border-t border-[#ece7de] bg-white/95 p-4 backdrop-blur xl:hidden"><div className="mx-auto max-w-[640px] rounded-[20px] border border-[#efe8dc] bg-white px-5 py-5 shadow-[0_10px_30px_rgba(17,17,17,0.06)]">{mobileSummary}</div></div> : null}
          </div>
        </div>
      </section>
    </MainShell>
